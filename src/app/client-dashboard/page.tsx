    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: 820, margin: "0 auto", padding: "clamp(80px,12vw,100px) 20px 60px" }}>
        <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 2 }}>
                ...
                <span className="pill pill-blue" style={{ fontSize: 13 }}><span className="pill-dot" />Client</span>
              </div>
              {profile.bio && <div style={{ fontSize: 15, color: "var(--text-3)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{profile.bio}</div>}
              {profile.walletAddress && (
                <div className="font-mono" style={{ fontSize: 14, color: "var(--text-3)", marginTop: 2 }}>
          ...
          {needsReview.length > 0 && (
            <div style={{
              ...
              <button onClick={() => router.push(`/escrow/${needsReview[0].id}`)} className="btn-primary"
                style={{ padding: "8px 16px", borderRadius: "var(--r-sm)", fontSize: 15, flexShrink: 0 }}>
                Review
              </button>
            </div>
          )}
          ...
          {/* Contract list */}
          <div style={{ fontSize: 17, fontWeight: 600, marginBottom: 12 }}>Your contracts</div>
              ...
              {contracts.map((c, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 16, fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{c.serviceTitle}</div>
                    ...
                    <div style={{ textAlign: "right", flexShrink: 0 }}>
                      <div className="font-mono" style={{ fontSize: 16, color: "var(--text-1)" }}>
